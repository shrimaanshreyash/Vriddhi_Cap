		...
		"views": {
			"payables": workspace_view(
				...
				[
					...
					link("Accounts Payable", "/app/query-report/Accounts%20Payable", "Accounts Payable"),
				],
				[
					...
					group(
						"Reports",
						[
							link("Accounts Payable", "/app/query-report/Accounts%20Payable"),
							link("Accounts Payable Summary", "/app/query-report/Accounts%20Payable%20Summary"),
							link("Purchase Register", "/app/query-report/Purchase%20Register"),
							link("Supplier Ledger Summary", "/app/query-report/Supplier%20Ledger%20Summary"),
						],
					),
				],
			),
			"receivables": workspace_view(
				...
				[
					...
					link("Payment Entry", "/app/payment-entry", "Payment Entry"),
					link("Journal Entry", "/app/journal-entry", "Journal Entry"),
					link("Accounts Receivable", "/app/query-report/Accounts%20Receivable", "Accounts Receivable"),
				],
				[
					...
					group(
						"Reports",
						[
							link("Accounts Receivable", "/app/query-report/Accounts%20Receivable"),
							link("Accounts Receivable Summary", "/app/query-report/Accounts%20Receivable%20Summary"),
							link("Sales Register", "/app/query-report/Sales%20Register"),
							link("Sales Invoice Trends", "/app/query-report/Sales%20Invoice%20Trends"),
						],
					),
				],
			),
			"gst": workspace_view(
				...
				[
					link("GST Composition", "/app/query-report/GST%20Balance"),
					link("Recent GST Invoices", "/app/sales-invoice"),
					link("GST Feature Evidence", "/app/vriddhi-capital?focus=feature_coverage"),
					link("HSN/SAC Evidence", "/app/hsn-code"),
				],
				[
					group("GST Evidence", [link("GST Composition", "/app/query-report/GST%20Balance"), link("Recent GST Invoices", "/app/sales-invoice"), link("Feature Checklist", "/app/vriddhi-capital?focus=feature_coverage")]),
					group("Compliance Notes", [link("E-invoice/IRN Evidence", "/app/e-invoice-log"), link("Seeded Data Coverage", "/app/vriddhi-capital?focus=data_coverage")]),
				],
			),
			"reports": workspace_view(
				...
				[
					link("General Ledger", "/app/query-report/General%20Ledger"),
					link("Trial Balance", "/app/query-report/Trial%20Balance"),
					link("P&L Statement", "/app/query-report/Profit%20and%20Loss%20Statement"),
					link("Cash Flow", "/app/query-report/Cash%20Flow"),
				],
				[
					group("Ledgers", [link("General Ledger", "/app/query-report/General%20Ledger"), link("Customer Ledger Summary", "/app/query-report/Customer%20Ledger%20Summary"), link("Supplier Ledger Summary", "/app/query-report/Supplier%20Ledger%20Summary")]),
					group("Financial Statements", [link("Trial Balance", "/app/query-report/Trial%20Balance"), link("Profit and Loss Statement", "/app/query-report/Profit%20and%20Loss%20Statement"), link("Balance Sheet", "/app/query-report/Balance%20Sheet"), link("Cash Flow", "/app/query-report/Cash%20Flow")]),
					group("Profitability", [link("Gross Profit", "/app/query-report/Gross%20Profit"), link("Profitability Analysis", "/app/query-report/Profitability%20Analysis"), link("Purchase Invoice Trends", "/app/query-report/Purchase%20Invoice%20Trends")]),
				],
			),
